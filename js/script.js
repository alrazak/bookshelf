...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function addTodo() {
    ...
    const todoObject = generateTodoObject(generatedID, textTitle, textAuthor, timestamp, false);
  ...
  function makeTodo(todoObject) {
    ...
    timestamp.innerText = todoObject.year;
   
    const textContainer = document.createElement('div');
    textContainer.classList.add('inner');
    textContainer.append(textTitle, textAuthor, timestamp);
